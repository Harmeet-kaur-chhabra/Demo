...
public abstract class AbstractLoanItemReader implements ItemReader<Loan> {
    ...
    public AbstractLoanItemReader(LoanRepository loanRepository, List<Long> alreadyLockedOrProcessedAccounts,
			List<Long> remainingData, Long loanId) {
		super();
		this.loanRepository = loanRepository;
		this.alreadyLockedOrProcessedAccounts = alreadyLockedOrProcessedAccounts;
	...
	protected List<Long> alreadyLockedOrProcessedAccounts;
    @Setter(AccessLevel.PROTECTED)
    private List<Long> remainingData;
    protected static Long loanId;
