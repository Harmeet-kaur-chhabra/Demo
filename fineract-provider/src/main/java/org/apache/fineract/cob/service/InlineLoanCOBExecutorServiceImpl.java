...
public class InlineLoanCOBExecutorServiceImpl implements InlineExecutorService<Long> {
    ...
    public InlineLoanCOBExecutorServiceImpl(GoogleGsonSerializerHelper gsonFactory,
			LoanAccountLockRepository loanAccountLockRepository, InlineLoanCOBExecutionDataParser dataParser,
			JobLauncher jobLauncher, JobLocator jobLocator, JobExplorer jobExplorer,
