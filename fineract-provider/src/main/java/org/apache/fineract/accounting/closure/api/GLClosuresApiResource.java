...
public class GLClosuresApiResource {
    ...
    public GLClosuresApiResource(PlatformSecurityContext context,
			GLClosureReadPlatformService glClosureReadPlatformService,
			DefaultToApiJsonSerializer<GLClosureData> apiJsonSerializerService,
