...
public class FinancialActivityAccountsApiResource {
    ...
    public FinancialActivityAccountsApiResource(PlatformSecurityContext context,
			FinancialActivityAccountReadPlatformService financialActivityAccountReadPlatformService,
			DefaultToApiJsonSerializer<FinancialActivityAccountData> apiJsonSerializerService,
			ApiRequestParameterHelper apiRequestParameterHelper,
			PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService) {
		super();
		this.context = context;
		this.financialActivityAccountReadPlatformService = financialActivityAccountReadPlatformService;
